...
df = pd.read_csv("/home/deva/Documents/dpd-db/dps/csvs/dps_full.csv", sep="\t", dtype= str)
...
# save csv
df_combined_final.to_csv("/home/deva/Documents/dpd-db/dps/csvs/sbs_pd.csv", sep="\t", index=False)
